...
from _lib import (
    C_IN, C_OP, C_OUT, C_REG, C_RED, C_SMEM, arrow, box, footer, grid, label,
    new_fig, save, title,
)
...
def main():
    ...
    grid(ax, 0.3, 3.0, 1.8, 3.6, cols=4, rows=6, face=C_IN,
    ...
    # A and B into smem
    arrow(ax, (2.1, 4.5), (rx, 6.0), color="#666", linewidth=1.0,
          connectionstyle="arc3,rad=-0.15")
    arrow(ax, (5.6, 6.35), (rx, 6.4), color="#666", linewidth=1.0,
          connectionstyle="arc3,rad=-0.1")

    # Epilogue back to C
    arrow(ax, (rx, 4.8), (5.6, 4.5), color="#888", linewidth=1.0,
